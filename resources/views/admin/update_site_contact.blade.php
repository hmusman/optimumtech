            ...
            <div class="page-title-box">
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="page-title mb-1">Update Website Contact</h4>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title">Update Website Contact</h4>
                               
                                    <form method="post" action="{{ route('SiteContact.update',$contact->id) }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" value="{{ $contact->email }}" name="email" type="email" placeholder="Enter Email" id="example-text-input">
                                                @error('email')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" value="{{ $contact->phone }}" name="phone" type="text" placeholder="Enter Class Duration" id="example-text-input">
                                                @error('phone')
                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" value="{{ $contact->skype }}" name="skype" type="text"  id="example-text-input">
                                                @error('skype')
                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                @enderror
                                            </div>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea id="textarea" class="form-control" name="address"  rows="3" placeholder="Enter Address">{{ $contact->address }}</textarea>
                                                @error('address')
                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                @enderror
                                            </div>
            ...
            <div data-simplebar class="h-100">
                ...
                <div class="tab-content text-muted">
                    ...
                    <div class="tab-pane" id="settings-tab" role="tabpanel">
                            <h6 class="px-4 py-3 bg-light">Add optimum Courses</h6>
