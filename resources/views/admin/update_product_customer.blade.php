                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="{{ route('ProductCustomer.update',$product->id) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" name="product">
                                                    ...
                                                    @foreach($products as $sproduct)
                                                         <option <?php if($product->id==$sproduct->id){ echo "selected=''"; } ?>  value="{{ $sproduct->id }}">{{ ucwords($sproduct->name) }}</option>
                                                    @endforeach
                                                </select>
                                                @error('product')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" value="{{ $product->name }}" name="name" type="text" placeholder="Enter Name" id="example-text-input">
                                                @error('name')
                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea id="textarea" class="form-control" name="detail" rows="3" placeholder="Enter Detail">{{ $product->detail }}</textarea>
                                                @error('detail')
                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" name="url" value="{{ $product->url }}"  placeholder="Enter Url" id="example-text-input">
                                                @error('url')
                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                @enderror
                                            </div>
