                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form method="post" action="{{ route('News.update',$news->id) }}" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea id="textarea" name="detail" class="form-control" maxlength="95" rows="3" placeholder="This textarea has a limit of 95 chars.">{{ $news->detail }}</textarea>
                                                                @error('detial')
                                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="mt-4">
                                                            <button type="submit" class="btn btn-primary waves-effect waves-light" type="submit">Update News</button>
                                                        </div>
