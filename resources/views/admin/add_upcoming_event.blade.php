                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form action="{{ route('Event.store') }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea id="textarea" name="detail" class="form-control" rows="3" placeholder="This textarea has a limit of 95 chars.">{{ old('detail') }}</textarea>
                                                                 @error('detail')
                                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                                @enderror  
                                                            </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input class="form-control" type="text" value="{{ old('address') }}" name="address" placeholder="Enter Event Loation" id="example-text-input">
                                                                @error('address')
                                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                                @enderror  
                                                            </div>
