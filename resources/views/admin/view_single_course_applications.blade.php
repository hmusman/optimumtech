                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered table-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                         <div class="row" style="margin-bottom: 15px;">
                                          ...
                                          <div class="col-md-2">
                                              <a href="{{ route('AllSingleCourseApplicationRecords',$id) }}" style="width: 100%; float: right;" class="btn-primary btn all_records">All Records</a>
                                          </div>
                                          ...
                                          <div class="col-md-3">
                                              <a href="{{ route('SingleConfirmedRecord',$id) }}" style="width: 100%; float: right;" class="btn-primary btn confirmRecords">Confirmed Records</a>
                                          </div>
                                          <div class="col-md-2">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.unconfirm').click(function(){
                ...
                {
                    $('.changeStatus').attr('action',"{{ route('SingleCourseApplicationUnConfirmStatus') }}");
                    $('.changeStatus').submit();
                }
            });
            ...
            $('.confirm').click(function(){
                if($('.changeStatusBox:checkbox').is(":checked"))
                {
                    $('.changeStatus').attr('action',"{{ route('SingleCourseApplicationConfirmStatus') }}");
                    $('.changeStatus').submit();
                }
            });
