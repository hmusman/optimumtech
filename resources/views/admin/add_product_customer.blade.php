                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title">Add New Product Customer</h4>
                                    @error('existMsg')
                                        <div class="alert alert-warning">{{ $message }}</div>
                                    @enderror
                                    <form method="post" action="{{ route('ProductCustomer.store') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" name="product">
                                                    ...
                                                    @foreach($products as $product)
                                                         <option <?php if(old('product')==$product->id){ echo "selected=''"; } ?>  value="{{ $product->id }}">{{ ucwords($product->name) }}</option>
                                                    @endforeach
                                                </select>
                                                @error('product')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" name="url" value="{{ old('url') }}"  placeholder="Enter Url" id="example-text-input">
                                                @error('url')
                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-md-2 col-form-label">Picture 200*120 </label>
                                            <div class="col-md-10">
