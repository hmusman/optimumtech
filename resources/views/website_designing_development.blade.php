      ...
      <div class="row">
        <div class="col-md-8 blog-pull-right">
          <div class="single-service">
            <img src="{{ asset('storage/images/services/static-website-vs-dynamic-website.png') }} " alt="">
