              ...
              <div class="owl-carousel-3col"  >
                <div class="item">
                  <div class="featured-blog">
                    <img src="{{ asset('storage/images/products/9XOWyYsKXH.png') }} " alt="">
                ...
                <div class="item">
                  <div class="featured-blog">
                    <img src="{{ asset('storage/images/products/79PYT5cQQT.png') }}" alt="">
                    <div class="featured-blog-details">
                ...
                <div class="item">
                  <div class="featured-blog">
                    <img src="{{ asset('storage/images/products/sm5KeJ0X6C.png') }}" alt="">
                    <div class="featured-blog-details">
    ...
    <div class="container mt-60">
      <div class="row">
        <div class="col-md-8 blog-pull-right">
          <div class="single-service">
            <img src="{{ asset('storage/images/services/lg2.jpg') }} " alt="">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <h3 class="text-theme-colored">Taxation Audit</h3>
         

          <p style="text-align: justify;">
            The outside company, known as a third-party provider arranges for it's own workers or and systems to perform their tasks or services either on site at the hiring company's own facilities. 

Outsourcing is a getting more popular in data innovation and for the administration of different business that have viewed as natural for delaying with business. For a company to effectively outsource responsibilities, it is crucial to focus on business partnership, managing relationship more than service-level agreements. 
            ...
            <p style="text-align: justify;">
              Maintaining and securing a trusted relationship is important in outsourcing efforts and is more complex than establishing service levels and relationships. 
Optimum Tech work nearly with the customer to enhance the employment efficiencies of nature of contract, staffing flexibility, rate of conveyance and expense regulation provide the best Outsourcing Service. 
          ...
          <p>
            Outsourcing is the most effective way to promote you business in today's era. There is thousands of business here that are in same boat and trying to up hold their business, aiming for the best logistics in the community. 
          </p><p style="text-align: justify;"> Optimum Tech will give you the service at low and pertinent costs, increased efficiency of whole system/management, provide access to skills or resources, we focus more on strategy and core competencies. It is about ensuring that through our services and efforts we will deliver to the right person, the right message and the right experience at the right time. 
            
          </p>

          <h4 class="text-theme-colored line-bottom text-theme-colored">Advantages</h4>
          <ul class="list">
            <li>Access to Skilled and Expertise</li>
            <li>Focus on core activities</li>
            <li>Run your business 24/7</li>

            <li>Reduce Cost and SAVE BIG</li>
            <li>Staffing Flexibility</li>

          <li>Give your business a competitive edge</li>
            <ul>
