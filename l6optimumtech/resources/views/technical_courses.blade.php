    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="{{ asset('storage/images/bg/bg3.jpg') }} ">
      <div class="container pt-70 pb-20">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white">Technical Courses</h3>
          ...
          <div class="row">
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mt-60 mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="{{ asset('storage/images/Courses/b-1.png') }}">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
                <div class="schedule-details clearfix p-15 pt-10">
                  <h5 class="font-16 title">Laravel Course 2020</h5>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mt-60 mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="{{ asset('storage/images/Courses/Blog-Object-Oriented-Programming.png') }}">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="schedule-box maxwidth500 bg-light mt-60 mb-30">
                <div class="thumb">
                  <img class="img-fullwidth" alt="" src="{{ asset('storage/images/Courses/Python-programming-india.png') }}">
                  <div class="overlay">
                    <a href="#"><i class="fa fa-calendar mr-5"></i></a>
                  </div>
                </div>
    ...
    <div class="container" >
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
          ...
          <a href="" target="_blank" > <button type="submit" class="btn btn-flat btn-theme-colored text-uppercase mt-10 mb-sm-30 border-left-theme-color-2-4px" data-loading-text="Please wait...">Book Technical Course</button></a>
        </div>
