                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <form action="{{ route('Product.update',$product->id) }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea id="textarea" class="form-control" name="detail" maxlength="95" rows="3" placeholder="This textarea has a limit of 95 chars.">{{ $product->detail }}</textarea>
                                                                @error('detail')
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input class="form-control" type="text" name="name" value="{{ $product->name }}" maxlength="100" placeholder="Enter  title" id="example-text-input">
                                                                @error('name')
                                                                    <p class="text-danger mt-3">{{ $message }}</p>
                                                                @enderror
                                                            </div>
