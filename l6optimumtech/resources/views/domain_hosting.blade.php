...
@section('content')
  ...
  <section>
    <div class="container mt-60">
      <div class="row">
        <div class="col-md-8 blog-pull-right">
          <div class="single-service">
            <img src="{{ asset('storage/images/services/51a6358167157 (2).png') }}" alt="">
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <h3 class="text-theme-colored">Domain & Hosting</h3>
            <h5><em>Domain & Hosting service of Solutions Player (Pvt) Ltd is the online portal which is all the way through an individual or a business project can get premium Domain Registration to mechanize their business procedures, functions, requirements and needs at most favorable or negotiable rates.
               <span class="text-theme-color-2">Electrical & Electronic</span> corporis dolorum blanditiis ullam officia 
               .</em></h5>
            <p>In our hosting services select the best one with:

              Shared Hosting (also known as multiple hosting, perfect for websites and blogs)
              WordPress Hosting (the best way to run WordPress open source)
              Virtual Private Servers (Perfect for businesses, Ecommerce, and developers)
              Dedicated Servers (Perfect for huge websites and resource heavy apps)</p>
            <p>Domain names on the internet are much similar to entry in a phone book and the hosting is much similar to the place that rented out to have a business in. we are as top ranked domain and web hosting provider, offers with an extensive range of hosting packages appropriate to small, medium and large enterprises.</p>
