...
(1, 'wordpress', 'this is description', NULL, '2020-08-12 05:21:39', '2020-09-05 02:25:08'),
(2, 'adobe photo', 'this is description', NULL, '2020-08-12 05:30:21', '2020-09-05 02:25:24'),
(3, 'website designing website development', 'this is description', NULL, '2020-08-12 05:31:38', '2020-09-05 02:26:46');
...
(2, 'Muhammad Waseem', 'waseemulfat961@gmail.com', '03013435656', 'test subject', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error optio in quia ipsum quae neque alias eligendi, nulla nisi. Veniam ut quis similique .', '0', '2020-09-03 00:54:03', '2020-09-03 02:45:13');
...
(1, '1', 'wordpress training', '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>The Cweren Law Firm is a recognized leader in landlord tenant representation throughout Texas.The largests professional property management companies the region.The largest professional property management companies is a recognized leader in landlord tenant representation throughout Texas</p>\r\n</body>\r\n</html>', 'admin/images/courses/4tdunslm5YGMpY2qQDhC1ik0H7up1gJS48D3Jnhe.png', 'free', '0', 'http://127.0.0.1:8000/CourseDetail/1', '1', 'test', 'test detail', '2020-08-06 04:48:31', '2020-09-07 07:06:56'),
(2, '3', 'nodejs', '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>The Cweren Law Firm is a recognized leader in landlord tenant representation throughout Texas.The largests professional property management companies the region.The largest professional property management companies is a recognized leader in landlord tenant representation throughout Texas nodejs</p>\r\n</body>\r\n</html>', 'admin/images/courses/JNb2pJGQBl2xfq0Qd7y4ytGKQmpib04khsn7ahyA.png', 'paid', '13500', 'http://127.0.0.1:8000/CourseDetail/2', '1', 'test', 'test', '2020-08-06 05:04:30', '2020-09-07 07:06:57');
...
CREATE TABLE `galleries` (
  ...
  `img` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sub_folder` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(10, 'portfolio', '2020-09-04 00:29:07', '2020-09-04 00:29:07');
...
(23, '2020_09_03_093951_create_portfolios_table', 19),
(24, '2020_09_07_053653_create_product_customers_table', 20),
(25, '2020_09_07_072657_create_site_contacts_table', 21);
...
(4, 'first', 'Optimum-Tech  Service. Himanshu and the team have always provided us with a prompt, reliable, aaa', '2020-08-07', 'admin/images/news/rYzq9INL37KVlcHPNVuDN3MCwAoVN6Yw5WMSEp2Q.png', 'test', 'test', '2020-08-06 07:16:56', '2020-09-05 00:22:19'),
(5, 'second', 'Optimum tech has played a significant role in the development of web based projects.Optimum tech has played a significant role in the development of web based projects.Optimum tech has played a significant role in the development of web based projects.Optimum tech has played a significant role in the development of web based projects.Optimum tech has played a significant role in the development of web based projects.', '2020-10-14', 'admin/images/news/029WC6CflqBD0MSBoKMkbOIw4oxvhHP1LG7rboqL.png', 'test', 'test', '2020-08-08 04:01:50', '2020-09-05 00:24:11'),
...
INSERT INTO `portfolios` (`id`, `name`, `service`, `url`, `objective`, `technology`, `img1`, `img2`, `img3`, `created_at`, `updated_at`) VALUES
(1, 'test', 'test', 'https://devsbeta.com', 'test', 'test', 'admin/images/product/bttLDwUQMqzJVpZhQmZYKRYsJZEeAWoj5iXVXwkj.png', 'admin/images/portfolio/BpgpgX908oAjxQNehjzA2ZbtoYQukWmEsL6TrKb9.png', 'admin/images/portfolio/KKGasobLOEtAQj7jorwrJrEJ3HHpkwfBHUpxexKT.png', '2020-09-03 05:43:19', '2020-09-03 05:43:19'),
(3, 'testdfdf', 'test', 'http://covid19.hn/', 'test', 'test', 'admin/images/product/zwLS6LPIEFsJ58Os1OwJ0P4fm5bxpLXgIEU0ZFBK.png', 'admin/images/portfolio/7IZjMkyDhUoJDQBuCSmtdZczVzxHMIGlMbqePLrp.png', 'admin/images/portfolio/mr55QpEkRyhWuVvUhnE0SlZGN5MzLK41FT9rlYju.png', '2020-09-03 06:02:06', '2020-09-04 00:49:50');
...
INSERT INTO `products` (`id`, `name`, `detail`, `img`, `meta_name`, `meta_detail`, `video`, `created_at`, `updated_at`) VALUES
...
(14, 'test', '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<p>test</p>\r\n</body>\r\n</html>', 'admin/images/product/cM5g2PNPLhjw4uwlCRbxymvW7E3txqHkJUWsinDz.png', 'test', 'tes', 'admin/images/product/videos/PuFDKtJBehYMRR0jPHeQaIunWIOet24lXOaYkdGm.mp4', '2020-09-05 05:38:04', '2020-09-05 05:38:04');
...
INSERT INTO `product_customers` (`id`, `product_id`, `name`, `url`, `detail`, `img`, `created_at`, `updated_at`) VALUES
(2, '1', 'test', 'http://ambulatory.com', 'test', 'admin/images/productCustomer/VcdsOJcg3aCeZ1aKuurlpMwF9d7orsqmKQjWvr33.jpeg', '2020-09-07 01:42:31', '2020-09-07 02:01:19');
...
INSERT INTO `site_contacts` (`id`, `email`, `phone`, `skype`, `address`, `created_at`, `updated_at`) VALUES
(1, 'info@optimumtech.com', '+923136650965', 'usman_gcuf?call', '25-a, batala colony main road 1st floor gourmet bakers near hardees Batala Colony Faisalabad.', NULL, '2020-09-07 03:07:53');
...
(4, 'admin/images/slider/d0CrT0WgaIdzh802bak7sONDPB25Eu5MFhHbLsVP.png', '2020-08-06 03:07:48', '2020-09-04 04:29:38');
...
(32, 8, 'wordpress', '/CourseCategory/1', NULL, 'courses', '2020-08-28 22:38:54', '2020-09-05 02:56:10'),
(34, 8, 'website designing website development', '/CourseCategory/3', NULL, NULL, '2020-08-28 22:59:36', '2020-09-05 02:36:44'),
...
(5, 'third', 'content writer', 'Optimum-Tech  has played a significant role in the development of web based projects. They have', 'admin/images/testimonials/IylkJWIN5ms6xy7WrVnCJwVYKP7fJZ98NWRrP3IG.jpeg', 'test', 'test', '2020-08-08 04:50:52', '2020-09-04 06:07:11');
